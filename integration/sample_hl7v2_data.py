...
PATIENT1_ADT_A01 = """MSH|^~\\&|HIS|MIAMI-HOSPITAL|FHIR|AZUREFHIR|{timestamp}||ADT^A01|MSG{msg_id}001|P|2.5
EVN|A01|{timestamp}
PID|1||PAT001^^^MRN||DOE^JOHN^ALLEN||19590515|M|||123 OCEAN DRIVE^^MIAMI^FL^33139^USA||(305)555-1234|||S
PV1|1|I|CARDIO^401^B||||DOC001^SMITH^JANE^A^^^MD||CARDIO||||ADM||||||||||||||||||||||||||||||{timestamp}"""
...
PATIENT2_ADT_A01 = """MSH|^~\\&|HIS|MIAMI-HOSPITAL|FHIR|AZUREFHIR|{timestamp}||ADT^A01|MSG{msg_id}003|P|2.5
EVN|A01|{timestamp}
PID|1||PAT002^^^MRN||SMITH^JANE^MARIE||19520320|F|||456 PALM AVENUE^^MIAMI^FL^33180^USA||(305)555-5678|||M
PV1|1|I|ENDO^302^A||||DOC002^JOHNSON^ROBERT^M^^^MD||ENDO||||ADM||||||||||||||||||||||||||||||{timestamp}"""
